...
const PROJECTS = [
  {
    ...
    status: 'DEPLOYED',
    statusLabel: 'SYSTEM',
    statusTooltip: 'Platform deployed and operational on Microsoft Azure',
    statusColor: 'moss',
    name: 'CUSTOS',
    subtitle: 'Cloud-Native Pre-Trade Risk & Regulatory Intelligence Platform',
    class: 'FINTECH / COMPLIANCE',
    version: 'v1.0.0',
    uptime: '99.99%',
    stack: ['Python', 'Azure Functions', 'Event Hubs', 'AI Search', 'Redis', 'Service Bus', 'Blob Storage', 'React'],
    description: 'Architected and deployed a four-module event-driven RegTech platform on Microsoft Azure, enabling real-time trade validation, LLM-based regulatory rule extraction from uploaded PDFs, immutable audit logging, and ML-driven anomaly monitoring. Designed to handle high-frequency simulated trade event streams with low-latency rule evaluation using Redis caching; implemented shadow-mode anomaly detection combining Isolation Forest and PyTorch Autoencoder with alert streaming via Service Bus. Delivered a full-stack cloud application with CI/CD on Azure Static Web Apps enabling live interaction with validation outputs, rule lifecycle management, and anomaly alert dashboards.',
    modules: [
      { name: 'Trade Validation', status: 'active', detail: 'Real-time deterministic rule evaluation with Redis caching' },
      { name: 'Regulatory AI', status: 'active', detail: 'LLM-based rule extraction from uploaded PDFs via AI Search' },
      { name: 'Audit Logging', status: 'active', detail: 'Immutable event audit trail via Service Bus' },
      { name: 'Anomaly Detection', status: 'active', detail: 'ML-driven monitoring via Isolation Forest + Autoencoder' },
    ],
    highlight: 'FULLY DEPLOYED ON AZURE: Cloud-native full-stack application with robust CI/CD pipelines.',
  },
  {
    id: 'relay',
    status: 'STABLE',
